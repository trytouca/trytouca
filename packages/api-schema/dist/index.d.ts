 ...
 */
export declare enum EPlatformRole {
    Guest = "guest",
    User = "user",
    Admin = "admin",
    Owner = "owner",
 ...
 *      type: string
 */
export declare type UserLookupResponse = {
    apiKeys: string[];
    email: string;
 ...
 */
export declare type NotificationListResponse = NotificationItem[];
/**
 * @schema CT_ETeamRole
 *  type: string
 *  enum: ['applicant', 'invited', 'member', 'admin', 'owner']
 */
export declare enum ETeamRole {
    Invalid = "unknown",
    Applicant = "applicant",
    Invited = "invited",
    Member = "member",
 ...
 *          type: number
 */
export declare type TeamLookupResponse = TeamItem & {
    userCount: number;
};
/**
 ...
 *    $ref: '#/components/schemas/CT_TeamItem'
 */
export declare type TeamListResponse = TeamItem[];
/**
 ...
 *      type: string
 */
export declare type TeamApplicant = {
    email: string;
    fullname: string;
    username: string;
};
 ...
 */
export declare type TeamMemberListResponse = {
 ...
 *      format: int32
 */
export declare type BatchCompareOverview = {
 ...
 *      format: date-time
 */
export declare type BatchItemRaw = {
    batchSlug: string;
 ...
 */
export declare type BatchItem = BatchItemRaw & {
 ...
 *          type: string
 */
export declare type BatchLookupResponse = BatchItem & {
    commentCount: number;
    suiteName: string;
    suiteSlug: string;
    teamName: string;
 ...
 *    $ref: '#/components/schemas/CT_BatchItem'
 */
export declare type BatchListResponse = BatchItem[];
/**
 ...
 *    $ref: '#/components/schemas/CT_CommentItem'
 */
export declare type CommentListResponse = CommentItem[];
/**
 * @schema CT_SuiteItem
 *  type: object
 *  additionalProperties: false
 ...
 *          type: string
 */
export declare type SuiteLookupResponse = SuiteItem & {
    batches: string[];
 ...
 *    $ref: '#/components/schemas/CT_SuiteItem'
 */
export declare type SuiteListResponse = SuiteItem[];
/**
 ...
 *      type: number
 */
export declare type CppTestcaseOverview = {
    keysCount: number;
    metricsCount: number;
 ...
 *      format: int32
 */
export declare type CppTestcaseComparisonOverview = {
 ...
 *      type: string
 */
export declare type BatchComparisonItem = {
    builtAt: Date;
    elementName: string;
};
/**
 ...
 *      $ref: '#/components/schemas/CT_BatchComparisonItem'
 */
export declare type BatchComparisonItemCommon = {
 ...
 */
export declare type BatchComparisonItemSolo = BatchComparisonItem & {
 ...
 *      $ref: '#/components/schemas/CT_BatchCompareOverview'
 */
export declare type BatchComparisonResponse = {
 ...
 *            type: number
 */
export declare type ElementListResponseItem = {
    metricsDuration: number;
    name: string;
    note: string;
    slug: string;
 ...
 */
export declare type ElementListResponse = ElementListResponseItem[];
/**
 ...
 *      type: string
 */
export declare type ElementLookupResponse = {
    batches: {
        slug: string;
        submittedAt: Date;
        updatedAt: Date;
 ...
 *          $ref: '#/components/schemas/CT_Userinfo'
 */
export declare type ElementComparisonItem = BatchComparisonItem & {
    submittedAt: Date;
    submittedBy: Userinfo;
};
/**
 ...
 *      type: string
 */
export declare type CppTypeComparison = {
    desc?: string[];
    dstType?: string;
    dstValue?: string;
    name: string;
 ...
 *      type: string
 */
export declare type CppTestcaseMetadata = {
    builtAt: Date;
    teamslug: string;
    testcase: string;
    testsuite: string;
 ...
 *      $ref: '#/components/schemas/CT_CppTestcaseMetadata'
 */
export declare type CppTestcaseComparison = {
 ...
 *      $ref: '#/components/schemas/CT_ElementComparisonItem'
 */
export declare type ElementComparisonResponse = {
 ...
 *      type: string
 */
export declare type PlatformStatsUser = {
 ...
 */
export declare type PlatformStatsResponse = {
