...
public final class StudentData {
    ...
    private static final StudentData[] students = new StudentData[] {
            ...
            new StudentData("bob", "Bob Brown", LocalDate.of(1996, 6, 30),
                    new Course[] { new Course("english", 3.7), new Course("history", 3.9) }),
            new StudentData("charlie", "Charlie Clark", LocalDate.of(2003, 9, 19),
                    new Course[] { new Course("math", 2.9), new Course("computers", 3.7) }) };

    private StudentData(final String username, final String fullname, final LocalDate dob, final Course[] courses) {
