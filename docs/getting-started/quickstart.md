...
To make testing complex workflows easier, we could significantly break down our implementation and test each _unit_ separately. But this general best practice may not solve all of the above-mentioned limitations. While writing unit tests is still very effective, we may want to hear that our compression algorithm, as a whole, works as expected.
