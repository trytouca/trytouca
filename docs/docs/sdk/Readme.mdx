...
| [Configuration profiles](#configuration-profiles)                       | <Check /> | <Check />  | <Check /> |           |
| [Version auto-increment](#version-auto-increment)                       | <Check /> | <Check />  | <Check /> |           |
| [Programmatic testcase declaration](#programmatic-testcase-declaration) | <Check /> | <Check />  | <Check /> |           |
| [Results Store](#results-store)                                         | <Check /> | <Check />  | <Check /> |           |
| [Multiple workflows](#multiple-workflows)                               | <Check /> | <Check />  | <Check /> |           |
...
JavaScript SDK supports this feature. You'd need to separately install the
[Touca CLI](../cli) and use it to write into configuration profiles from the
command-line.

</TabItem>
<TabItem value="cpp">

C++ SDK supports this feature. You'd need to separately install the
[Touca CLI](../cli) and use it to write into configuration profiles from the
command-line.
