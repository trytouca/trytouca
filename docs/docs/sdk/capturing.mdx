...
Touca data capturing functions automatically support objects, arrays, and other
common data types. You can extend and override our built-in serialization logic
for any given non-primitive data type.
