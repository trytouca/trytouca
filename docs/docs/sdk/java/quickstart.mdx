...
<Image img={require("/img/assets/touca-submit-first-version.png")} />
...
<Image img={require("/img/assets/touca-sdk-quickstart-1.png")} />
...
<Image img={require("/img/assets/touca-sdk-quickstart-2.png")} />
