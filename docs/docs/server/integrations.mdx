...
<ThemedImage
  ...
  sources={{
    light:
      "https://touca.io/docs/external/assets/touca-server-integrations-mail-section.light.png",
    dark: "https://touca.io/docs/external/assets/touca-server-integrations-mail-section.dark.png"
  }}
/>
