...
<Image img={require("/img/assets/touca-suite-page-single-version.png")} />
...
<Image img={require("/img/assets/touca-version-page-first.png")} />

We can also review the captured data for any one of the test cases.

<Image img={require("/img/assets/touca-case-page-first.png")} />
...
<Image img={require("/img/assets/touca-version-page-second.png")} />

We can inspect the differences reported for test case `alice` to understand the
impact of our recent code change.

<Image img={require("/img/assets/touca-case-page-second.png")} />
...
<Image img={require("/img/assets/touca-version-page-promote.png")} />
