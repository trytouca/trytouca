...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-suite-page-single-version.png"),
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-version-page-first.png"),
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-case-page-first.png"),
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-version-page-second.png"),
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-case-page-second.png"),
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-version-page-promote.png"),
