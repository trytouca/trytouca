...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-version-page-first.light.png"),
    dark: useBaseUrl("img/assets/touca-version-page-first.dark.png")
  }}
/>
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-case-page-first.light.png"),
    dark: useBaseUrl("img/assets/touca-case-page-first.dark.png")
  }}
/>
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-version-page-second.light.png"),
    dark: useBaseUrl("img/assets/touca-version-page-second.dark.png")
  }}
/>
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-case-page-second.light.png"),
    dark: useBaseUrl("img/assets/touca-case-page-second.dark.png")
  }}
/>
...
<ThemedImage
  sources={{
    light: useBaseUrl("img/assets/touca-version-page-promote.light.png"),
    dark: useBaseUrl("img/assets/touca-version-page-promote.dark.png")
  }}
/>
