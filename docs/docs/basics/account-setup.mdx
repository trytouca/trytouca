...
<ToucaImage
  src="touca-signup-page.png"
  dark="touca-signup-page-dark.png"
...
<ToucaImage
  src="touca-account-welcome.png"
  dark="touca-account-welcome-dark.png"
...
<ToucaImage
  src="touca-create-team.png"
  dark="touca-create-team-dark.png"
  title="Important buttons on Touca are always on the top-right corner."
/>
...
<ToucaImage
  src="touca-team-request-join.png"
  dark="touca-team-request-join-dark.png"
  title="You will need approval from a Team Admin to join that team."
/>
...
<ToucaImage
  src="touca-create-suite.png"
  dark="touca-create-suite-dark.png"
  title="You can always change the name and the slug of your suite from the Settings tab."
/>
...
<ToucaImage
  ...
  title="You will need API Key and API URL to submit test results."
/>
