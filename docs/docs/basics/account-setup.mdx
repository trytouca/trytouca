...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/assets/touca-signup-page.png"),
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/assets/touca-account-welcome.png"),
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/assets/touca-create-team.png"),
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/assets/touca-team-request-join.png"),
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/assets/touca-create-suite.png"),
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("img/assets/touca-submit-first-version.png"),
