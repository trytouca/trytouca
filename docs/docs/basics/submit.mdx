...
![trytouca/examples repository on GitHub](/img/assets/touca-github-repo-examples.png)
...
```typescript title="javascript/02_node_main_api/students.ts"
...
```typescript title="javascript/02_node_main_api/students_test.ts"
