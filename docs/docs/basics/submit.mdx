...
Lastly, let's set our API Key and API URL that we can obtain
[from the Touca server](/server/account-setup/#find-your-api-key).
...
first ever Touca test, cheers to many more! 🥂
