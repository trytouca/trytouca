...
## Getting Started <a href="#basics" id="basics"></a>
...
- [Manage Your Team](basics/manage-team.md)
- [Common Questions](basics/faq.md)

## API Reference <a href="#sdk" id="sdk"></a>

- [Python SDK](sdk/python/README.md)
  - [Getting Started](sdk/python/quickstart.md)
  - [Main API](sdk/python/main-api.md)
  - [Core API](sdk/python/core-api.md)
...
- [C++ SDK](sdk/cpp/README.md)
  - [Building](sdk/cpp/building.md)
  - [Installing](sdk/cpp/installing.md)
...
- [JavaScript SDK](sdk/javascript/README.md)
  - [Getting Started](sdk/javascript/quickstart.md)
  - [Main API](sdk/javascript/main-api.md)
