...
In the [previous tutorial](../01_node_minimal), we showed how to write and run a
simple Touca test using our Node.js SDK. But our `is_prime` example was too
...
[`students.ts`](students.ts) for a possible implementation.
