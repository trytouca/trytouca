...
sed -i '' 's/\("version":\).*/\1 "1.5.0",/g' "${DIR_EXAMPLES}/javascript/01_node_minimal/package.json"
sed -i '' 's/\("version":\).*/\1 "1.5.0",/g' "${DIR_EXAMPLES}/javascript/02_node_main_api/package.json"
sed -i '' 's/\("version":\).*/\1 "1.5.0",/g' "${DIR_EXAMPLES}/javascript/03_node_core_api/package.json"
sed -i '' 's/\("@touca\/node":\).*/\1 "^1.5.0"/g' "${DIR_EXAMPLES}/javascript/01_node_minimal/package.json"
sed -i '' 's/\("@touca\/node":\).*/\1 "^1.5.0"/g' "${DIR_EXAMPLES}/javascript/02_node_main_api/package.json"
sed -i '' 's/\("@touca\/node":\).*/\1 "^1.5.0"/g' "${DIR_EXAMPLES}/javascript/03_node_core_api/package.json"
...
sed -i '' 's/implementation.*/implementation("io.touca:touca:1.5.0")/g' "${DIR_EXAMPLES}/java/01_java_minimal/build.gradle.kts"
sed -i '' 's/implementation.*/implementation("io.touca:touca:1.5.0")/g' "${DIR_EXAMPLES}/java/02_java_main_api/build.gradle.kts"
sed -i '' 's/implementation.*/implementation("io.touca:touca:1.5.0")/g' "${DIR_EXAMPLES}/java/03_java_core_api/build.gradle.kts"
