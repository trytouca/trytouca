...
sed -i '' 's/implementation.*/implementation("io.touca:touca:0.2")/g' "${DIR_EXAMPLES}/java/01_java_minimal/build.gradle.kts"
sed -i '' 's/implementation.*/implementation("io.touca:touca:0.2")/g' "${DIR_EXAMPLES}/java/02_java_main_api/build.gradle.kts"
sed -i '' 's/implementation.*/implementation("io.touca:touca:0.2")/g' "${DIR_EXAMPLES}/java/03_java_core_api/build.gradle.kts"
